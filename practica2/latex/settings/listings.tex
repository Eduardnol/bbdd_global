...
\definecolor{backcolour1}{RGB}{37, 37, 37}
...
\lstset{
    xleftmargin=1.1cm,
    belowskip=2em,
    basicstyle=\fontsize{10}{15}\ttfamily\color{normalcode},
    basewidth  = {.5em,0.4em},
    captionpos=b,
    lineskip={2pt},
...
\lstdefinelanguage{JavaScript}{
    keywords={for, get,typeof, new, true, false, catch, then, function, return, null, catch, switch, var, if, in, while, do, else, case, break, default},
    keywordstyle=\color{lightpurple}\bfseries,
    ndkeywords={public, private, +=, -=, ==, =,static, final, println, System, class, export, boolean, throw, implements, import, this, const, int, String, double},
    ndkeywordstyle=\color{orange}\bfseries,
    identifierstyle=\color{normalcode},
    sensitive=false,
    comment=[l]{//},
    morecomment=[s]{/*}{*/},
    commentstyle=\color{comentCode}\ttfamily,
    stringstyle=\color{stringStyle}\ttfamily,
    morestring=[b]',
    morestring=[b]"
}
