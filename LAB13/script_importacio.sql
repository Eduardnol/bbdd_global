...
LOAD DATA LOCAL INFILE 'D:/OneDrive/Estudios/uni/Curso_2/bbdd/LAB13/movies_database_csv/movie_metadata.csv' INTO TABLE movies_importacio FIELDS TERMINATED BY ',' ENCLOSED BY '"' IGNORE 1 LINES;
LOAD DATA LOCAL INFILE 'D:/OneDrive/Estudios/uni/Curso_2/bbdd/LAB13/movies_database_csv/genres_metadata.csv' INTO TABLE genres_importacio FIELDS TERMINATED BY ',';
LOAD DATA LOCAL INFILE 'D:/OneDrive/Estudios/uni/Curso_2/bbdd/LAB13/movies_database_csv/producer_metadata.csv' INTO TABLE producer_importacio FIELDS TERMINATED BY ',';
LOAD DATA LOCAL INFILE 'D:/OneDrive/Estudios/uni/Curso_2/bbdd/LAB13/movies_database_csv/language_metadata.csv' INTO TABLE language_importacio FIELDS TERMINATED BY ',';
