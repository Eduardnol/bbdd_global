...
COPY imp_pelis FROM 'D:\OneDrive\Estudios\uni\Curso_2\bbdd\LAB10\csv_Files/movies.csv' DELIMITER '@';

COPY imp_users FROM 'D:\OneDrive\Estudios\uni\Curso_2\bbdd\LAB10\csv_Files\users.csv' DELIMITER '@';

COPY imp_ratings FROM 'D:\OneDrive\Estudios\uni\Curso_2\bbdd\LAB10\csv_Files/ratings.csv' DELIMITER '@';
...
COPY RangEdat FROM 'D:\OneDrive\Estudios\uni\Curso_2\bbdd\LAB10\csv_Files\edades.csv' DELIMITER '@';

COPY Ocupacio FROM 'D:\OneDrive\Estudios\uni\Curso_2\bbdd\LAB10\csv_Files\ocupaciones.csv' DELIMITER '@';
